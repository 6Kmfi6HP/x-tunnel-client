...
- Overview dashboard with runtime, traffic, channel, listener, reconnect, proxy, recent-log, raw-detail panels, and quick navigation to operational pages.
