...
- Diagnostics page with preset/custom direct/local-proxy HTTP tests, local listen-port status badge, direct/proxy/forward route status chips, copyable diagnostics summary, copyable network and forward-test results, profile forward endpoint TCP tests, redacted export, and log access.
