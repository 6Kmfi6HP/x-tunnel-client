...
- Settings page with immediate English / Simplified Chinese language switching, localized option labels, profile/subscription metadata summaries, profile endpoint batch status, profile form placeholders, and runtime-mode text, core executable auto-detect, visible and copyable core path/version status, one-click core version check, copyable local folder summary, and app-data, profile, log, and runtime folder shortcuts.
