...
- Settings page with core executable auto-detect, visible and copyable core path status, copyable local folder summary, and app-data, profile, log, and runtime folder shortcuts.
