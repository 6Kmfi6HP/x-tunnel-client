...
- Overview dashboard with runtime, traffic, channel, listener, reconnect, proxy, quick proxy-mode actions, one-click network test, recent-log, raw-detail panels, and quick navigation to operational pages.
