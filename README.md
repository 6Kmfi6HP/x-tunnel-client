...
- Profiles page with search/filter, scannable profile metadata, structured form editing, advanced JSON editing, core-backed format/check, field issue list, secret validation, and local port checks.
