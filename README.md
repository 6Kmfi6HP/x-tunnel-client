...
- Profiles page with search/filter, saved/name/endpoint sorting, profile summary counts, copyable redacted profile summaries, fastest-profile selection, clearable forward-endpoint latency badges, structured form editing, advanced JSON editing, core-backed format/check, field issue list, secret validation, and local port checks.
