...
- Subscriptions page for saving sources, updating selected or all subscriptions, updating profiles by name, and tracking aggregate fetch/cache status.
